...
PARAMETER_NOTES: tuple[Mapping[str, Any], ...] = (
    ...
    {"path": "state_tracking.minimum_confidence", "kind": "tracking threshold",
     "plain": "Minimum overlap for one nearest-neighbour state match.",
     "units": "overlap in [0,1]", "invalidates_checkpoint": True,
     "increase": "more assignments marked ambiguous", "decrease": "accepts weaker identity evidence",
     "interacts": "the separate 0.80 BO outcome constraint decides trial feasibility"},
    {"path": "state_tracking.minimum_assignment_margin", "kind": "tracking threshold",
     "plain": "Minimum best-versus-runner-up overlap separation.",
     "units": "overlap difference", "invalidates_checkpoint": True,
     "increase": "more near-crossing assignments rejected", "decrease": "accepts less decisive matches",
     "interacts": "used by both live nearest-neighbour and fixed-anchor acceptance"},
    {"path": "state_tracking.energy_continuity_weight", "kind": "tracking setting",
     "plain": "Weight of real energy continuity as a secondary assignment cost.",
     "units": "dimensionless", "invalidates_checkpoint": True,
     "increase": "energy order influences ties more", "decrease": "overlap dominates more completely",
     "interacts": "energies must be real solver or parsed output; fabricated indices are forbidden"},
    {"path": "state_tracking.ambiguity_threshold", "kind": "Stage 5 tracking threshold",
     "plain": "Stricter fixed-anchor margin used to accept a validation conclusion.",
     "units": "overlap difference", "invalidates_checkpoint": False,
     "increase": "more anchored cases are inconclusive", "decrease": "accepts tighter alternatives",
     "interacts": "does not change the immutable optimization observations"},
    {"path": "state_tracking.anchor_case", "kind": "Stage 5 tracking setting",
     "plain": "The one fixed design every Stage 5 case is assigned against.",
     "units": "case name", "invalidates_checkpoint": False,
     "increase": "n/a", "decrease": "n/a",
     "interacts": "reference_abrupt is order independent; a missing or mismatched anchor stops the check"},
    ...
    {"path": "numerical.number_of_hole_states", "kind": "fixed simulation setting",
     "plain": "How many heavy-hole states the solver is asked for.",
     "units": "count", "invalidates_checkpoint": True,
     "increase": "safer hole-state sum, slower", "decrease": "risks truncation and missed near-degeneracy",
     "interacts": "each energy must stay paired with its envelope for tracking"},
    {"path": "numerical.quantum_region_padding_nm", "kind": "fixed simulation setting",
     "plain": "Padding around the active quantum region used to select states.",
     "units": "nm", "invalidates_checkpoint": True,
     "increase": "includes more surrounding material", "decrease": "risks clipping state character",
     "interacts": "distinct from outer domain padding"},
    ...
    {"path": "metric.broadening_meV", "kind": "fixed physics setting",
     "plain": "Homogeneous linewidth in the relative chi(2) denominator.",
     "units": "meV", "invalidates_checkpoint": True,
     "increase": "smooths and broadens resonances", "decrease": "sharpens them",
     "interacts": "changes objective magnitude and how near-degenerate gaps are interpreted"},
    ...
    {"path": "validation_study.state_count_convergence", "kind": "Stage 5 setting",
     ...
     "units": "count", "invalidates_checkpoint": False,
     "increase": "tests a larger state window", "decrease": "tests truncation sensitivity",
     "interacts": "fixed-anchor labels must remain stable across the window"},
    {"path": "validation_study.domain_padding_nm", "kind": "Stage 5 setting",
     "plain": "Outer-domain paddings used for convergence checks.",
     "units": "nm", "invalidates_checkpoint": False,
     "increase": "larger validation domain", "decrease": "smaller validation domain",
     "interacts": "maximum boundary probability must remain below its bound"},
)
