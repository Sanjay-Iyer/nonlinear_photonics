...
Last written: 2026-09-05 14:51 UTC

| Demo | Question | Tier | Status | Pro required? | Runtime estimate | Prerequisite | Main conclusion |
|---|---|---:|---|---|---|---|---|
| 27A | Can nextnano++ Professional export usable finite-k state, spinor and matrix data at k != 0? | 1 | READY | Yes | 5 min - 21 min | none |  |
| 27B | Does the frozen-numerator approximation M(k) = M(0) change any Equation 2 pathway? | 2 | BLOCKED | Yes | 1 h - 3 h | 27A |  |
| 27C | Are the four states Equation 2 currently uses sufficient, or do other states carry optical weight? | 2 | BLOCKED | Yes | 30 min - 2 h | 27A |  |
...
| 27F | Could numerical-domain choices be creating or moving the higher states? | 2 | READY | Yes | 2.5 h - 6 h | none |  |
| 27G | What does the paper's "one tenth of the Brillouin zone" physically correspond to? | 2 | READY | Yes | 1 h - 3 h | none |  |
| 27H | Is the radial (isotropic) in-plane assumption valid for these states and matrix elements? | 2 | READY | Yes | 30 min - 1.5 h | none |  |
