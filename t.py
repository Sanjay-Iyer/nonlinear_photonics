...
# Define the filename and raw markdown content
filename = "replicate_paper.md"
markdown_content = r"""# Modeling-Only Replication Plan: Enhanced Interband Optical Nonlinearities
